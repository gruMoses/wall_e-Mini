...
- ch1/ch2: 990–2010 µs -> 0–255 (inclusive), with CENTER_OUTPUT_VALUE=126 at 1500 µs
...
def map_pulse_to_byte(pulse_us: int) -> int:
    ...
    - Else clamp pulse to [990, 2010] and map linearly to [0, 255]
    - Endpoints map exactly: 990 -> 0, 2010 -> 255
    """
