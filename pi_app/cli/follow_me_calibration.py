...
def parse_log_line(raw: str) -> Optional[Sample]:
    ...
    return Sample(
        ...
        person_confidence=float(d.get("follow_me_target_confidence", 0.0)),
        obstacle_scale=float(obs.get("throttle_scale", 1.0)),
        steer_offset=d.get("follow_me_steer_offset"),
        speed_offset=d.get("follow_me_speed_offset"),
        distance_error_m=d.get("follow_me_distance_error_m"),
