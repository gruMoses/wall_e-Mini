...
class TestSafety(unittest.TestCase):
    def test_arm_disarm_with_debounce(self):
        ...
        s, events = update_safety(s, ch3_us=1100, ch4_us=1000, ch5_us=1000, now_epoch_s=now, params=params)
        ...
        s, events = update_safety(s, ch3_us=1900, ch4_us=1000, ch5_us=1000, now_epoch_s=now, params=params)
        ...
        s, events = update_safety(s, ch3_us=1000, ch4_us=1000, ch5_us=1000, now_epoch_s=now + 0.1, params=params)
        self.assertTrue(s.is_armed)
        self.assertEqual(events, [])

        # After debounce window -> disarm event
        s, events = update_safety(s, ch3_us=1000, ch4_us=1000, ch5_us=1000, now_epoch_s=now + 0.4, params=params)
        self.assertFalse(s.is_armed)
    ...
    def test_emergency_rising_edge_latches(self):
        ...
        s, events = update_safety(s, ch3_us=1500, ch4_us=1000, ch5_us=1900, now_epoch_s=now, params=params)
        ...
        s2, events = update_safety(s, ch3_us=1900, ch4_us=1000, ch5_us=1500, now_epoch_s=now + 1.0, params=params)
    ...
    def test_ch3_midband_holds_state(self):
        ...
        s, events = update_safety(s, ch3_us=1500, ch4_us=1000, ch5_us=1000, now_epoch_s=now, params=params)
        self.assertFalse(s.is_armed)
        self.assertEqual(events, [])
